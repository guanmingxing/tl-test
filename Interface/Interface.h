...
namespace tl_interface{
  ...
  class DIRInfo{
    ...
    std::shared_ptr<paddr_t>              dirWReq_bits_way;//addr
    ...
    std::shared_ptr<paddr_t>              tagWReq_bits_way;//addr
    std::shared_ptr<uint8_t>              tagWReq_bits_tag;//addr
    
    std::shared_ptr<uint8_t>              clientDirWReq_valid;//valid
    std::shared_ptr<paddr_t>              clientDirWReq_bits_set;//addr
    std::shared_ptr<paddr_t>              clientDirWReq_bits_way;//addr
    ...
    std::shared_ptr<paddr_t>              clientTagWreq_bits_way;//addr
    std::shared_ptr<uint8_t>              clientTagWreq_bits_tag;//addr
