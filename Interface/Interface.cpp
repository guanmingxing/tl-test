...
namespace tl_interface{
  ...
  DIRInfo::DIRInfo(uint64_t cid, uint8_t bt)
  {
    ...
    dirWReq_bits_way.reset(new paddr_t(0));//addr
    ...
    tagWReq_bits_way.reset(new paddr_t(0));//addr
    tagWReq_bits_tag.reset(new uint8_t(0));//addr
    
    clientDirWReq_valid.reset(new uint8_t(0));//valid
    clientDirWReq_bits_set.reset(new paddr_t(0));//addr
    clientDirWReq_bits_way.reset(new paddr_t(0));//addr
    ...
    clientTagWreq_bits_way.reset(new paddr_t(0));//addr
    clientTagWreq_bits_tag.reset(new uint8_t(0));//addr
  }
...
void tlc_monitor_eval(
  ...
  const svBitVecVal*    clientTagWreq_bits_tag//addr
    ...
    *(dir_info->dirWReq_bits_way) = *(paddr_t *)dirWReq_bits_way;//addr
    ...
    *(dir_info->tagWReq_bits_way) = *(paddr_t *)tagWReq_bits_way;//addr
    *(dir_info->tagWReq_bits_tag) = *tagWReq_bits_tag;//addr
    ...
    *(dir_info->clientDirWReq_bits_way) = *(paddr_t *)clientDirWReq_bits_way;//addr
    ...
    *(dir_info->clientTagWreq_bits_way) = *(paddr_t *)clientTagWreq_bits_way;//addr
    *(dir_info->clientTagWreq_bits_tag) = *clientTagWreq_bits_tag;//addr
