...
namespace tl_agent {
    ...
    class BaseAgent {
        ...
        public:
            ...
            // void connect(Port<ReqField, RespField, EchoField, BEATSIZE> *p) {
            //     this->port = p;
            // }

            // void drive_signal_to_slave_b(
    ...
    // void BaseAgent::get_signal_from_slave_b(
    //     svLogicVecVal*  opcode,
    //     svLogicVecVal*  param,
    //     svLogicVecVal*  size,
    //     svLogicVecVal*  source,
    ...
    //     svLogic*        corrupt
    // ) {
    //     *opcode     = port->b.opcode;
    //     *param      = port->b.param;
    //     *size       = port->b.size;
    //     *source     = port->b.source;
    //     *address    = port->b.address;
    //     *corrupt    = port->b.corrupt;
    // }
}
