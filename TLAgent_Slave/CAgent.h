...
namespace tl_agent {
    ...
    class CAgent : public BaseAgent {
        ...
        public:
            ...
            Resp send_b(std::shared_ptr<ChnB> &b);                                  //TODO
            Resp send_d(std::shared_ptr<ChnD<RespField, EchoField, DATASIZE>> &d);   //TODO
            ...
            bool do_grantAck();     //TODO
            bool do_releaseAck();   //TODO
            bool do_probe();        //TODO
            bool do_grantData(int address, int param, int size, int source, uint8_t *data, int dirty);
